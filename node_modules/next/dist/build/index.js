...
async function build(dir, conf = null) {
    ...
    const configs = await Promise.all([
        webpack_config_1.default(dir, { buildId, isServer: false, config, target: config.target, entrypoints: entrypoints.client }),
        webpack_config_1.default(dir, { buildId, isServer: true, config, target: config.target, entrypoints: entrypoints.server })
    ]);
