...
module.exports = (context, options = {}) => {
    const presetEnvConfig = Object.assign({ 
        ...
        modules: isDevelopment || isProduction ? false : 'auto' }, options['preset-env']);
    return {
        presets: [
        ...
        plugins: [
            ...
            [require('@babel/plugin-transform-runtime'), Object.assign({ corejs: 2, helpers: true, regenerator: true, useESModules: !isTest && presetEnvConfig.modules !== 'commonjs' }, options['transform-runtime'])],
