...
var _MinuteView = _interopRequireDefault(require("../../views/MinuteView"));
...
function (_BasePicker) {
  ...
  function MinutePicker(props) {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "getSelectableCellPositions", function () {
      return _lodash.default.range(0, MINUTES_ON_PAGE);
    });
  ...
  _createClass(MinutePicker, [{
    ...
    value: function buildCalendarValues() {
      ...
      */
      ...
      return _lodash.default.range(0, 60, MINUTES_STEP).map(function (minute) {
    ...
    value: function render() {
      ...
      return _react.default.createElement(_MinuteView.default, _extends({}, rest, {
